...
const Navbar = () => {
  ...
  return (
    <>
      <div className="font-Nunito bg-companyRed  h-auto w-full lg:relative z-50">
        ...
        <div className='flex flex-wrap justify-between items-center '>
          <div className='relative flex-1  mx-4 lg:hidden'>
              ...
              <button className='bg-companyWhite text-center w-[70px] h-[30px] mr-10 lg:hidden text-companyRed rounded-3xl  '> <Link to={'login'} > Sign in </Link> </button>
        </div>
