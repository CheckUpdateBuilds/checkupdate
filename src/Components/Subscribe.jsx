    ...
    <>
        <div className="text-center bg-companyLightRed">
            ...
            <div className="p-5 m-5 text-center rounded-3xl bg-companyWhite">
                <input className="block w-full border-0 ring-1 h-[50px] rounded-full text-black ring-inset ring-black sm:text-sm/6 hover:shadow-md px-7" type="text" placeholder="@example.com" />
                <button className="bg-companyRed hover:bg-red-700 text-center w-[150px] h-[67px] mt-6 text-white rounded-full hover:text-black">Subscribe <i className="fa fa-arrow-up" aria-hidden="true"></i></button>
